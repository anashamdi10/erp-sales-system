...
<form action="{{route('admin.suppliers_orders.do_approve', $data['auto_serial']) }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-3">
            ...
            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="tax_percent" id="tax_percent" class="form-control" value="{{$data['tax_percent']*1}}">
        </div>
        <div class="form-group col-lg-3">
            <label> القيمة الضريبة المضافة </label>
            <input readonly type="text" name="tax_value" id="tax_value" class="form-control" value="{{$data['tax_value']*1}}">
        </div>
        <div class="form-group col-lg-3">
        ...
        <div class="form-group col-lg-3">
            ...
            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="discount_percent" @if($data["discount_type"]=='' ||$data["discount_type"]==null ) readonly @endif id="discount_percent" class="form-control" value="{{$data['discount_percent']*1}}">
        </div>
        <div class="form-group col-lg-3">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-3">
            ...
            <input type="text" name="what_paid" id="what_paid" class="form-control" @if($data["pill_type"]==1) readonly value=" {{$data['total_cost']*1}} " @else value="0 " @endif>
        </div>
        <div class="form-group col-lg-3">
            <label> المتبقي للمورد </label>
            <input readonly type="text" name="what_remain" id="what_remain" class="form-control" @if($data["pill_type"]==1) value="0" @else value=" {{$data['total_cost']*1}} " @endif>
        </div>
        <div class="form-group col-lg-12 text-center">
            <hr>
            <button type="submit" id="do_close_approve_invoice" style="padding: 10px;" class="btn btn-sm   btn-danger"> اعتماد والترحيل الان</button>
    ...
    <div class="alert alert-danger">
        عفوا لا يمكن الاعتماد الفاتورة قبل اضافة الاصناف عليها  !!
    </div>
    @endif
