...
<a href="{{ route('admin.suppliers_orders_general_return.index') }}"> فواتير مرتجع المشتريات الغام </a>
@endsection
...
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 " style="left: 320px;">
                        <h3 class="card-title"> تفاصيل فاتورة مرتجع المشتريات عام </h3>
                    </div>
                    @if($data['is_approved']==0)
                    <div class="col-lg-6 text-right ">
                        <a href="{{route('admin.suppliers_orders_general_return.edit',$data['id'])}}" class="btn btn-sm btn-success" style="margin-right: 50px;"> تعديل</a>
                        <a href="{{ route('admin.suppliers_orders_general_return.delete',$data['id']) }}" class="btn btn-sm  are_you_sure btn-danger">حذف</a>
            ...
            <div class="card-body">
                ...
                <input type="hidden" id="ajax_add_new_details" value="{{ route('admin.suppliers_orders_general_return.ajax_add_new_details') }}">
                <input type="hidden" id="ajax_reload_itemsdetails" value="{{ route('admin.suppliers_orders_general_return.reload_itemsdetails') }}">
                ...
                <input type="hidden" id="ajax_load_model_add_details" value="{{ route('admin.suppliers_orders_general_return.load_model_add_details') }}">
                <input type="hidden" id="ajax_edit_item_details" value="{{ route('admin.suppliers_orders_general_return.edit_item_details') }}">
                <input type="hidden" id="ajax_load_model_approve_invoice" value="{{ route('admin.suppliers_orders_general_return.load_model_approve_invoice') }}">
                <input type="hidden" id="ajax_load_usershiftDiv" value="{{ route('admin.suppliers_orders_general_return.load_usershiftDiv') }}">
                <input type="hidden" id="ajax_get_inv_itemcard_batches" value="{{ route('admin.suppliers_orders_general_return.get_inv_itemcard_batches') }}">
                <input type="hidden" id="ajax_add_return_items_from_invoice" value="{{ route('admin.suppliers_orders_general_return.add_return_items_from_invoice') }}">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content bg-info">
                <div class="modal-header">
                    <h4 class="modal-title">إضافة مرتجع للفاتورة </h4>
    ...
    <div class="modal fade " id="ModelApproveInvoice">
        <div class="modal-dialog modal-xl">
            <div class="modal-content bg-info">
                <div class="modal-header">
                    <h4 class="modal-title text-center" style="width:100% ;"> اعتماد وترحيل فاتورة مرتجع مشتريات عام </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
