                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td style="text-align: center;">
                           ...
                           <a href="{{ route('admin.suppliers_orders_general_return.delete',$info->id) }}" class="btn btn-sm  are_you_sure btn-danger">حذف</a>
                           @endif
                           <a href="{{ route('admin.suppliers_orders_general_return.show',$info->id) }}" class="btn btn-sm   btn-info">الاصناف </a>
                        </td>
                     </tr>
                     @php
                     $i++;
