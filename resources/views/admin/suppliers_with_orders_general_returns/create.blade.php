    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center"> إضافة فاتورة مرتجع مشتريات جديدة </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">

                <form action="{{route('admin.suppliers_orders_general_return.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
