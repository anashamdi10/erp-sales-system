...
<div class="card">
   <div class="card-header">
      ...
      <input type="hidden" id="ajax_show_current_balance_account" value="{{ route('admin.exchange_tranaction.show_current_balance_account') }}">
      <input type="hidden" id="ajax_search" value="{{ route('admin.ExchangeController.search') }}">
