...
<a href="{{ route('admin.exchange_tranaction.index') }}"> شاشة تحصيل النقدية </a>
@endsection
   ...
   <div class="col-12">
      <div class="card">
         ...
         @if(!empty($check_exsits_shifts))
            <form action="{{route('admin.exchange_tranaction.store')}}" method="post">
               @csrf
               ...
               <div class="row ">
                  ...
                  <div class="col-md-4 ">
                     <div class="form-group">
                        ...
                        <input type="date" name="mov_date"
                           id="mov_date" class="form-control"  
                           value="{{old('mov_date',date('Y-m-d'))}}">
                        @error('mov_date')
                  ...
                  <div class="col-md-4 ">
                     <div class="form-group">
                        ...
                        <input readonly name="treasuries_balance"
                           id="treasuries_balance" class="form-control"   
                           value="{{$check_exsits_shifts['treasures_balance_now']*1}}">
                  ...
                  <div class="col-md-4 ">
                     <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="money"
                  ...
                  <div class="col-md-6 ">
                     <div class="form-group">
                        <label>   البيان </label>
                        <textarea class="form-control" name="bayan" id="bayan" rows="4" cols="10">  {{old('bayan' , 'صرف نظير')}}</textarea>
                        @error('byan')
                           <span class="text-danger">{{$message}}</span>
                        @enderror    
                     </div>
         ...
         @else
            <div class="alert alert-warning">
               تنبيه : لايوجد شيفت مفتوح لك لكي تتمكن من الصرف !!
            </div>
         @endif   
...
@section('script')
    ...
    <script src="{{asset('admin/js/exchange_tranaction.js')}}"></script>
    <script>
        $(function () {
