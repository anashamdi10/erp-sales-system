   ...
   <div class="col-12">
      <div class="card">
         <div class="card-header">
            ...
            <a href="{{ route('admin.admin_shift.create') }}" class="btn btn-sm btn-success" >اضافة جديد</a>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
            <div class="col-md-4">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="{{ route('admin.admins_accounts.details',$info->id) }}"  class="btn btn-sm  btn-info">صلاحيات الخاصة</a>   
                        </td>
                     </tr>
                     @php
                     $i++; 
