    ...
    <div class="col-md-4  related_to_itemCard" id="UomDivAdd">
        <div class="form-group">
            ...
            <select name="uom_id_edit" id="uom_id_edit" class="form-control select2 ">
                ...
                <option @if($item_card_data['uom_id']==$item_data_details['uom_id']) selected @endif data-isparentuom='0' value="{{ $item_card_data['retail_uom_id'] }}"> {{ $item_card_data['retail_uom_name'] }} (وحده تجزئة) </option>
