    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.suppliers_orders.update' ,$data['id'])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Doc_No" id="Doc_No" class="form-control" value="{{ old('Doc_No',$data['Doc_No'])}}" >
