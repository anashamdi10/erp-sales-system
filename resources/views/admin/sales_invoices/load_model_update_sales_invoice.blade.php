    ...
    <div class="col-md-2" id="customerDiv">
        <div class="form-group">
            ...
            <select name="customer_code" id="customer_code" class="form-control select2 ">
                ...
                <option @if($invoice_data['customer_code']==$info->customer_code and
                    $invoice_data['is_has_customer']==1) selected @endif value="{{ $info->customer_code }}">
                    {{ $info->name }} </option>
                @endforeach
                @endif
            </select>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group ">
            <label> الكمية </label>
            <input value="1" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" id="quantity"
                class="form-control">
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="form-group ">
            ...
            <input readonly oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" id="item_total"
                class="form-control">
        </div>
    </div>
    <div class="col-md-3">
...
<div class="row">
    ...
    <div class="form-group col-lg-3">
        ...
        <input readonly type="text" name="total_cost_items" id="total_cost_items" class="form-control"
            value="{{$invoice_data['total_cost_items']}}">
    </div>
    <div class="form-group col-lg-3">
        <label> نسبة الضريبة </label>
        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="tax_percent" id="tax_percent"
            class="form-control" value="{{$invoice_data['tax_percent']}}">
    </div>
    <div class="form-group col-lg-3">
        <label> قيمة الضريبة </label>
        <input readonly type="text" name="tax_value" id="tax_value" class="form-control"
            value="{{$invoice_data['tax_value']}}">
    </div>
    <div class="form-group col-lg-3">
        <label> الاجمالي قبل الخصم </label>
        <input readonly type="text" name="total_befor_discount" id="total_befor_discount" class="form-control"
            value="{{$invoice_data['total_befor_discount']}}">
    </div>
    ...
    <div class="form-group col-lg-3">
        ...
        <select class="form-control" id="discount_type" name="discount_type">
            ...
            <option @if ($invoice_data['discount_type']==1) selected @endif value="2"> قيمة يدوي</option>
    ...
    <div class="form-group col-lg-3">
        ...
        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="discount_percent"
            id="discount_percent" class="form-control" value="{{$invoice_data['discount_percent']}}">
    </div>
    <div class="form-group col-lg-3">
        <label> قيمة الخصم </label>
        <input readonly type="text" name="discount_value" id="discount_value" class="form-control"
            value="{{$invoice_data['discount_value']}}">
    </div>
    <div class="form-group col-lg-3">
        <label> الاجمالي النهائي </label>
        <input readonly type="text" name="total_cost" id="total_cost" class="form-control"
            value="{{$invoice_data['total_cost']}}">
    </div>
</div>
<div class="row" id="shift_div">
    ...
    <div class="form-group col-lg-3">
        ...
        <input readonly type="text" name="treasures_balance" id="treasures_balance" class="form-control"
            @if(!@empty($user_shifts)) value=" {{$user_shifts['current_blance']*1}} " @else value="0" @endif>
    </div>
    ...
    <div class="form-group col-lg-12 text-center">
        ...
        <button type="submit" id="do_close_approve_invoice" style="padding: 10px;" class="btn btn-sm   btn-success">
            طباعه عرض الاسعار </button>
